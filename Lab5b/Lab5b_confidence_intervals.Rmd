...
In this sample, 55% of the population think that climate change affects their lives

2.  Would you expect another student's sample proportion to be identical to yours? 
    Would you expect it to be similar? Why or why not?

No, I wouldn't expect another student's sample distribution to be similar to mine because It is very unlikely that we draw the same sample. Though, I will expect the proportion of people that believe climate change affects their lives to be somewhat similar.
...
"95% confidence" means that we are 95% confident that the true proportion of US adults who think climate change affects their local community is between 43.3% and 66.7%. 
...
Yes, my confidence interval capture the true population proportion.
...
I will expect  around 95% of those intervals to capture the true mean of the population because on average, you can expect 95% of your confidence intervals to capture the true population parameter.
...
Given the default values for the app, 48/50 or 96% of my confidence intervals include the true population. My confidence interval is slightly different than the confidence level because each sample and each set of bootstrap samples may yield different results due to random variation. 
